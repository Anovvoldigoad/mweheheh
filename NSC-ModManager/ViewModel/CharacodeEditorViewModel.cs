    ...
    public class CharacodeEditorViewModel : INotifyPropertyChanged {
        ...
        public void SearchEntry() {
            if (CharacodeTextBoxString is not null) {
                ...
                System.Windows.MessageBox.Show("There is no characode with that name.", "No result", MessageBoxButton.OK, MessageBoxImage.Error);
            } else {
                System.Windows.MessageBox.Show("Write characode in field!");
            }
        }
            ...
            if (CharacodeTextBoxString is not null) {
                for (int c = 0; c < CharacodeList.Count; c++) {
                    if (CharacodeList[c].CharacodeName == CharacodeTextBoxString) {
                        ...
                        System.Windows.MessageBox.Show("This characode already exist in game!", "No result", MessageBoxButton.OK, MessageBoxImage.Error);
                        return;
                    }
                }
                CharacodeEditorModel char_id = new CharacodeEditorModel();
                ...
                System.Windows.MessageBox.Show("Write characode name in field");
            }
        }
